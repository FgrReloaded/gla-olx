                ...
                <div className={styles.innerBox}>
                    <div className={styles.sliderBox}>
                        <div className={styles.sliderElement}>
                            <Image width={500} height={100} src={mainSlider} alt="img" />
                        </div>
                    ...
                    <div className={styles.imgBox}>
                        <Image width={500} height={100} src={images[0]} alt={images[0]} onClick={(e) => { setMainSlider(e.target.alt) }} />
                        <Image width={500} height={100} src={images[1]} alt={images[1]} onClick={(e) => { setMainSlider(e.target.alt) }} />
                        <Image width={500} height={100} src={images[2]} alt={images[2]} onClick={(e) => { setMainSlider(e.target.alt) }} />
                        <Image width={500} height={100} src={images[3]} alt={images[3]} onClick={(e) => { setMainSlider(e.target.alt) }} />
                    </div>
